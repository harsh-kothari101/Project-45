...
//buttons...............................................
var setting,settingI,forward,forwardI,backward,backwardI;
...
//characters...........................................................
var shin,shinI,chan,chanI,doraemon,doraemonI,nobi,nobiI,nobita,nobitaI;      
...
function setup(){
    ...
    backward=createSprite(displayWidth/13,displayHeight/8,50,50);
...
function draw(){ 
    ...
    if(gameState === 1){
        ...
        if(mousePressedOver(china)){
            gameState = 0;
        }

        if(mousePressedOver(india)){
            gameState = 0;
        }

        if(mousePressedOver(korea)){
            gameState = 0;
        }

        if(mousePressedOver(pak)){
            gameState = 0;
        }

        if(mousePressedOver(sri)){
            gameState = 0;
        }

        if(mousePressedOver(usa)){
            gameState = 0;
        }

        if(mousePressedOver(eng)){
            gameState = 0;
        }
    }
